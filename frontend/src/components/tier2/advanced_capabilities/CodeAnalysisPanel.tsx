...
import { Code, Upload, AlertTriangle , Settings} from 'lucide-react'
import POCConfigManager from '../../POCConfigManager'
import FileUpload from '../../FileUpload'

interface CodeAnalysisPanelResponse {
  results: any
  insights: string[]
...
export default function CodeAnalysisPanel() {
  ...
  const [result, setResult] = useState<CodeAnalysisPanelResponse | null>(null)
  const [error, setError] = useState<string | null>(null)

  const handleSubmit = async () => {
    if (!textInput.trim()) {
      setError('Please enter a code analysis query')
      return
    }
    ...
    try {
      const response = await axios.post<CodeAnalysisPanelResponse>(
        'http://localhost:8000/api/v1/modules/code-analysis/analyze',
        { text: textInput },
...
<div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Analyze code quality, security, and performance</p>
      </div>
          </div>
          <button
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Upload source code files, repositories, or code analysis reports.
        </p>
        <FileUpload
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <textarea
          ...
          placeholder="Enter your code analysis query..."
          rows={4}
