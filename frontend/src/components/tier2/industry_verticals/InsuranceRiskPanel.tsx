...
export default function InsuranceRiskPanel() {
  ...
  const handleSubmit = async () => {
    if (!textInput.trim()) {
      setError('Please enter an insurance risk assessment query')
      return
    }
...
<div className="mb-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4">📋 Upload Insurance Data</h2>
        <p className="text-sm text-gray-600 mb-4">
          Upload insurance applications, policy documents, or risk assessment data.
        </p>
        <FileUpload
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <textarea
          ...
          placeholder="Enter your insurance risk assessment query..."
          rows={4}
