...
### [setup/](./setup/)
Setup guides for various components (LLM models, local development, etc.).
...
- [setup/MULTI_MODEL_SETUP.md](./setup/MULTI_MODEL_SETUP.md)

**Need to debug?**
- [debugging/DEBUG_QUICK_REFERENCE.md](./debugging/DEBUG_QUICK_REFERENCE.md)
- [debugging/RAG_DEBUGGING_GUIDE.md](./debugging/RAG_DEBUGGING_GUIDE.md)
