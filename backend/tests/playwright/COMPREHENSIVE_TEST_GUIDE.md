...
│   ├── finetuning_page.py                  # Fine-tuning UI
│   └── export_wizard_page.py               # ⭐ NEW: Export Wizard
│
├── test_export_wizard_e2e_comprehensive.py  # ⭐ NEW: 20+ Export tests
├── test_phase2_enhancements_e2e.py          # ⭐ NEW: 15+ Phase 2 tests
├── test_consolidated_services_e2e.py        # Existing: Service tests
├── test_chat_ui_comprehensive.py            # Existing: Chat tests
├── test_users_crud.py                       # Existing: User management
├── test_roles_crud.py                       # Existing: Role management
├── test_departments.py                      # Existing: Department tests
│
├── run_comprehensive_tests.sh               # ⭐ NEW: Master test runner
...
| **Navigation** | 2 | Back button, step transitions |
| **Export Job** | 4 | Create job, progress tracking, completion |
| **Download** | 1 | ZIP file download |
| **Error Handling** | 1 | Error display and recovery |
| **Workflow** | 2 | Complete Tier 2/3 workflows |
...
### Phase 2 Enhancement Tests (15+ tests)

| Category | Tests | Description |
|----------|-------|-------------|
| **System Config** | 5 | API health, CRUD, caching |
| **Model Registry** | 4 | List models, Ollama discovery, sync |
| **Agent Runtime** | 3 | Task creation, model selection |
...
| Category | Tests | Description |
|----------|-------|-------------|
| **Chat UI** | 5+ | Chat interface, message sending |
| **User Management** | 3+ | Create/update/delete users |
| **Role Management** | 3+ | Create/update/delete roles |
| **Departments** | 2+ | Department CRUD |
| **Services** | 5+ | Consolidated services, project filtering |

**Test Files**:
- `test_chat_ui_comprehensive.py`
- `test_users_crud.py`
- `test_roles_crud.py`
- `test_departments.py`
- `test_consolidated_services_e2e.py`

---

## Test Files

### NEW: test_export_wizard_e2e_comprehensive.py

**Purpose**: Comprehensive E2E tests for Export Wizard

**Test Classes**:
- `TestExportWizardE2E` - Main test class (20+ tests)
...
11. `test_regression_*` - Regression tests
12. `test_modal_opens_quickly` - Performance test
...
### NEW: test_phase2_enhancements_e2e.py
...
**5. Add breakpoint in test:**

```python
def test_something(export_wizard_page):
    export_wizard_page.click_export_wizard_button()
...
jobs:
  e2e-tests:
    ...
    steps:
      ...
      - name: Run E2E Tests
        run: bash backend/tests/playwright/run_comprehensive_tests.sh --quick --report
...
|----------|-------|--------|
| Export Wizard | 20+ | ✅ Complete |
| System Config | 5 | ✅ Complete |
| Model Registry | 4 | ✅ Complete |
| Agent Runtime | 3 | ✅ Complete |
| Integration | 2 | ✅ Complete |
| Regression | 7 | ✅ Complete |
| Existing Tests | 15+ | ✅ Working |
